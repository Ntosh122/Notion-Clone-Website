...
const tabs = [
  {
    ...
    images: [
      { title: "Board", picture: "/assets/board.png" },
      { title: "Table", picture: "/assets/table.png" },
      { title: "Timeline", picture: "/assets/timeline.png" },
      { title: "Calender", picture: "/assets/calendar.png" },
      { title: "Gallery", picture: "/assets/gallery.png" },
      { title: "List", picture: "/assets/en-US.webp" },
    ],
      ...
      <div className="flex flex-col  pt-20 xl:py-32 items-center justify-center">
        ...
        <div className="items-center flex justify-center flex-col">
          ...
          <div className="m text-center">
            <div className="text-sm  font-medium pt-4">Rahim Makani</div>
            <div className="text-sm">Director of Product, Matchgroup</div>
          </div>
        </div>
      </div>
    </>
